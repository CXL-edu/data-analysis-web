...
const Icon: React.FC<IconProps> = ({ name, className = '', size = 20 }) => {
  ...
  const icons = {
    // Navigation icons
    chevronLeft: (
      <svg className={className} style={iconStyle} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    history: (
      <svg className={className} style={iconStyle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    // User icons
    user: (
      <svg className={className} style={iconStyle} fill="currentColor" viewBox="0 0 20 20">
