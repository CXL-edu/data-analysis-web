...
export default function Footer() {
  return (
    // <footer className="relative bg-gray-50 dark:bg-gray-900 z-10">
    <footer className="relative bg-white/90 dark:bg-gray-900/70 z-10">
    {/* <footer className="relative bg-gradient-to-r from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 z-10"> */}
    <hr className="my-0.2 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-0.2" />
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <Link href="/" className="flex items-center">
                    <Image src="/favicon1.svg" width={32} height={32} className="h-8 me-3" alt="数源智能" />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-center">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                        <li className="mb-4">
                            <Link href="https://github.com/CXL-edu/data-analysis-web" className="hover:underline" target="_blank" rel="noopener noreferrer">Github</Link>
                        </li>
                        {/* <li>
                            <Link href="https://discord.gg/4eeurUVvTy" className="hover:underline" target="_blank" rel="noopener noreferrer">Discord</Link>
                        </li> */}
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li>
                            <Link href="/privacy-policy" className="hover:underline">隐私政策</Link>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="https://github.com/CXL-edu/data-analysis-web" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
